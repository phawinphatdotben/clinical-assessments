...
-- Internal Medicine Health Education (CHMD 7403 PDF rubric; tiers 1–4 per criterion)
alter table public."Assessment"
...
-- Interesting Case Presentation rubric
alter table public."Assessment"
...
-- Interesting Case Presentation (General) rubric
alter table public."Assessment"
...
-- OPD Clinical Assessment (non-pediatric)
alter table public."Assessment"
...
-- Anticipatory Guidance assessment (Pediatrics)
alter table public."Assessment"
